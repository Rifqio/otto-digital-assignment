...
export const greetingFormSchema = z.object({
    dear: z
        ...
        .max(20, { message: "Recipient must be less than 50 characters" }),
    message: z
        .string()
        .nonempty({ message: "Message must be filled" })
        .max(50, { message: "Message must be less than 200 characters" }),
    from: z.string().nonempty({ message: "From must be filled" }).max(20, { message: "From must be less than 50 characters" }),
